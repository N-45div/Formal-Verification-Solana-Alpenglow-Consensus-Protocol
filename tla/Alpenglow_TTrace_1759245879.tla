---- MODULE Alpenglow_TTrace_1759245879 ----
...
_prop ==
    ~<>[](
        ...
        certificates = ({})
        /\
        blocks = ({[slot |-> 0, hash |-> 1, parent |-> -1], [slot |-> 0, hash |-> 2, parent |-> 1]})
        /\
        timeouts = ((n1 :> {} @@ n2 :> {} @@ n3 :> {}))
        /\
        ...
        relayGraph = ((n1 :> {} @@ n2 :> {} @@ n3 :> {}))
        /\
        votes = ({[slot |-> 0, type |-> "NotarVote", block |-> 1, node |-> n1], [slot |-> 0, type |-> "NotarVote", block |-> 2, node |-> n3]})
        /\
        shreds = ({})
        /\
        nodeStates = ((n1 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}) @@ n2 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}) @@ n3 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {})))
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Alpenglow_TTrace_1759245879.json", _TETrace)
...
\*
\*trace == IODeserialize("Alpenglow_TTrace_1759245879.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([finalized |-> {},slots |-> 0,certificates |-> {},blocks |-> {[slot |-> 0, hash |-> 1, parent |-> -1]},timeouts |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),leaders |-> (0 :> n1 @@ 1 :> n1 @@ 2 :> n1),relayGraph |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),votes |-> {[slot |-> 0, type |-> "NotarVote", block |-> 1, node |-> n1]},shreds |-> {},nodeStates |-> (n1 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}) @@ n2 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}) @@ n3 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}))]),
    ([finalized |-> {},slots |-> 0,certificates |-> {},blocks |-> {[slot |-> 0, hash |-> 1, parent |-> -1], [slot |-> 0, hash |-> 2, parent |-> 1]},timeouts |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),leaders |-> (0 :> n1 @@ 1 :> n1 @@ 2 :> n1),relayGraph |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),votes |-> {[slot |-> 0, type |-> "NotarVote", block |-> 1, node |-> n1], [slot |-> 0, type |-> "NotarVote", block |-> 2, node |-> n3]},shreds |-> {},nodeStates |-> (n1 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}) @@ n2 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}) @@ n3 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}))]),
    ([finalized |-> {},slots |-> 1,certificates |-> {},blocks |-> {[slot |-> 0, hash |-> 1, parent |-> -1], [slot |-> 0, hash |-> 2, parent |-> 1]},timeouts |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),leaders |-> (0 :> n1 @@ 1 :> n1 @@ 2 :> n1),relayGraph |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),votes |-> {[slot |-> 0, type |-> "NotarVote", block |-> 1, node |-> n1], [slot |-> 0, type |-> "NotarVote", block |-> 2, node |-> n3]},shreds |-> {},nodeStates |-> (n1 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}) @@ n2 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}) @@ n3 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}))]),
    ([finalized |-> {},slots |-> 2,certificates |-> {},blocks |-> {[slot |-> 0, hash |-> 1, parent |-> -1], [slot |-> 0, hash |-> 2, parent |-> 1]},timeouts |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),leaders |-> (0 :> n1 @@ 1 :> n1 @@ 2 :> n1),relayGraph |-> (n1 :> {} @@ n2 :> {} @@ n3 :> {}),votes |-> {[slot |-> 0, type |-> "NotarVote", block |-> 1, node |-> n1], [slot |-> 0, type |-> "NotarVote", block |-> 2, node |-> n3]},shreds |-> {},nodeStates |-> (n1 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}) @@ n2 :> (0 :> {} @@ 1 :> {} @@ 2 :> {}) @@ n3 :> (0 :> {"Voted", "VotedNotar"} @@ 1 :> {} @@ 2 :> {}))])
    >>
----
...
---- CONFIG Alpenglow_TTrace_1759245879 ----
CONSTANTS
    Nodes = { n1 , n2 , n3 }
    MaxSlot = 2
    WindowSize = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Sep 30 15:24:43 UTC 2025